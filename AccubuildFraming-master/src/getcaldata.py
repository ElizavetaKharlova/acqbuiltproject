...
def main():
    ...
    for i in range(IMAGES_NUM):
        ...
        checkerboard.delta_location = [ random.uniform(-CHECKBRD_DIST_DELTA_VAR,CHECKBRD_DIST_DELTA_VAR), random.uniform(-CHECKBRD_DIST_DELTA_VAR,CHECKBRD_DIST_DELTA_VAR), random.uniform(-CHECKBRD_DIST_DELTA_VAR,CHECKBRD_DIST_DELTA_VAR)]
