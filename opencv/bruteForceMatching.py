...
img1 = cv.imread('./images/depth_new.jpg', 0)
img2 = cv.imread('./images/warp_new_topRight.jpg', 0 )
...
matches = bf.knnMatch(np.asarray(des1[1], np.float32), np.asarray(des2[1], np.float32))
